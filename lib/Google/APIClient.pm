...
#    use Google::APIClient::Logging;

    #use Method::Signatures::Simple method_keyword => 'def',
...
#    attr_reader :authorization
    has 'authorization' => ( isa => 'Str', is => 'ro' );
...
#    def authorization=(new_authorization)
    action set_authorization($new_authorization) {
...
#    attr_accessor :auto_refresh_token
    has 'auto_refresh_token' => ( isa => 'Bool', is => 'rw' );
...
#    attr_accessor :discovery_path
    has 'discovery_path' => ( isa => 'Str', is => 'rw' );
...
#    attr_accessor :expired_auth_retry
    has 'expired_auth_retry' => ( isa => 'Bool', is => 'rw' );
...
#    def register_discovery_uri(api, version, uri)
    action register_discovery_uri($api, $version, $uri) {
#      api = api.to_s
#      version = version || 'v1'
...
#    def discovery_uri(api, version=nil)
    action discovery_uri($api, $version) {
#      api = api.to_s
#      version = version || 'v1'
...
#    def register_discovery_document(api, version, discovery_document)
    action register_discovery_document($api, $version, $discovery_document) {
#      api = api.to_s
#      version = version || 'v1'
...
#    def discovery_document(api, version=nil)
    action discovery_document($api, $version) {
#      api = api.to_s
#      version = version || 'v1'
...
#    def discovered_api(api, version=nil)
    action discovered_api($api, $version) {
...
#    def discovered_method(rpc_name, api, version=nil)
    action discovered_method($rpc_name, $api, $version) {
...
#    def generate_request(options={})
    action generate_request($options) {
#      options = {
#        :api_client => self
#      }.merge(options)
...
#    def resolve_uri(template, mapping={})
    action resolve_uri($template, $mapping) {
